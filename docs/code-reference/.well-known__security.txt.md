...
Public security contact file used by browsers, researchers, and scanners to find responsible disclosure information.
...
```
Contact: mailto:otienomaurice12340@gmail.com
Preferred-Languages: en
Canonical: https://mauriceotieno.com/.well-known/security.txt
Policy: https://mauriceotieno.com/
```
